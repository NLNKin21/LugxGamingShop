                ...
                <c:forEach var="p" items="${trendingProducts}" varStatus="loop">
                    <c:if test="${loop.index < 4}">
                        <div class="col-lg-3 col-md-6">
                            <div class="item">
                                <div class="thumb">
                                    <a href="/product/${p.id}"><img src="/images/product/${p.image}" alt="${p.name}" style="width:100%; height:220px; object-fit:cover;"></a>
                                    
                                    <c:choose>
                                        <c:when test="${p.price == 0}">
                                            <span class="price">FREE</span>
                                        </c:when>
                                        <c:when test="${p.price >= 1000000}">
                                            <span class="price"><fmt:formatNumber value="${p.price}" pattern="#,##0"/>₫</span>
                                        </c:when>
                                        <c:otherwise>
                                            <span class="price"><em><del><fmt:formatNumber value="${p.price + 300000}" pattern="#,##0"/>₫</del></em> <fmt:formatNumber value="${p.price}" pattern="#,##0"/>₫</span>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                                <div class="down-content">
                                    ...
                                    <h4>${p.name}</h4>
                                    <a href="/cart/add/${p.id}"><i class="fa fa-shopping-bag"></i></a>
                                </div>
                            </div>
                        </div>
                    </c:if>
                ...
                <c:forEach var="p" items="${mostPlayedProducts}" varStatus="loop">
                    <c:if test="${loop.index < 6}">
                        <div class="col-lg-2 col-md-4 col-sm-6">
                            <div class="item">
                                <div class="thumb">
                                    <a href="/product/${p.id}"><img src="/images/product/${p.image}" alt="${p.name}" style="height:140px; object-fit:cover;"></a>
                                </div>
                                <div class="down-content">
                                    <span class="category">${p.category}</span>
                                    <h4>${p.name}</h4>
            ...
            <div class="row">
                ...
                <div class="col-lg col-sm-6 col-xs-12">
                    <div class="item">
                        <h4>Battle Royale</h4>
                        <div class="thumb">
                            <a href="/shop?category=BattleRoyale"><img src="/client/images/categories-01.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg col-sm-6 col-xs-12">
                    <div class="item">
                        <h4>MOBA</h4>
                        <div class="thumb">
                            <a href="/shop?category=MOBA"><img src="/client/images/categories-05.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg col-sm-6 col-xs-12">
                    <div class="item">
                        <h4>FPS</h4>
                        <div class="thumb">
                            <a href="/shop?category=FPS"><img src="/client/images/categories-03.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg col-sm-6 col-xs-12">
                    <div class="item">
                        <h4>RPG</h4>
                        <div class="thumb">
                            <a href="/shop?category=RPG"><img src="/client/images/categories-04.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg col-sm-6 col-xs-12">
                    <div class="item">
                        <h4>Account Game</h4>
                        <div class="thumb">
                            <a href="/shop?category=Account"><img src="/client/images/categories-05.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
